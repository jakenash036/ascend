...
export async function sendPasswordResetEmail(to: string, resetUrl: string) {
  await resend.emails.send({
    from: "Ascend <noreply@ascendescapeaverage.com>",
    to,
    ...
    html: `
      <div style="background:#0a0a0a;color:#e8e8e3;font-family:sans-serif;padding:40px;max-width:480px;margin:0 auto;">
        <p style="font-size:11px;letter-spacing:0.4em;text-transform:uppercase;color:#808080;margin-bottom:24px;">Ascend — Escape Average</p>
